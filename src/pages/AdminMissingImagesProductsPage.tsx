...
const AdminMissingImagesProductsPage = () => {
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mb-6 p-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold">Products Without Images</h1>
            <div className="w-24"></div>
          </div>
        </Card>

        <MasterProductsTable systemSellerId={systemSeller?.user_id} showMissingImages={true} />
      </main>
    </div>
  );
};

export default AdminMissingImagesProductsPage;
